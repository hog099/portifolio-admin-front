...
export const Profile: React.FC = () => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    favicon: Yup.string().required("O FavIcon é obrigatório"),
                ...
                >
                  ...
                  <div className={styles["wrapper-inputs"]}>
                    ...
                    <Input
                      ...
                      onChange={({ target }) =>
                        setValue("fullname", target.value)
                      }
                    ...
                    <Input
                      ...
                      helperText={
                        errors?.responsible ? errors?.responsible.message : null
                      }
                      customCssContainer={{ marginBottom: 30, width: 250 }}
                      type="text"
                      value={getValues("responsible")}
                      onChange={({ target }) =>
                        setValue("responsible", target.value)
                      }
                    ...
                    <Input
                      {...register("whatsapp")}
                      helperText={
                        errors?.whatsapp ? errors?.whatsapp.message : null
                      }
                      customCssContainer={{ marginBottom: 30, width: 250 }}
                      type="text"
                      value={getValues("whatsapp")}
                      onChange={({ target }) =>
                        setValue("whatsapp", formatPhoneNumber(target.value))
                      }
                    ...
                    <Input
                      {...register("address01")}
                      helperText={
                        errors?.address01 ? errors?.address01.message : null
                      }
                      customCssContainer={{ marginBottom: 30, width: 250 }}
                      type="text"
                      value={getValues("address01")}
                      onChange={({ target }) =>
                        setValue("address01", target.value)
                      }
                    ...
                    <Input
                      ...
                      onChange={({ target }) =>
                        setValue("number", Number(target.value))
                      }
                      placeholder="Número"
                      label="Número"
                      disabled={editMode ? false : true}
                    ...
                    <Input
                      {...register("address02")}
                      helperText={
                        errors?.address02 ? errors?.address02.message : null
                      }
                      customCssContainer={{ marginBottom: 30, width: 250 }}
                      type="text"
                      value={getValues("address02")}
                      onChange={({ target }) =>
                        setValue("address02", target.value)
                      }
                    ...
                    <Input
                      ...
                      onChange={({ target }) => setValue("logo", target.value)}
                      placeholder="Logo"
                      label="Logo"
                      disabled={editMode ? false : true}
                    />
                    ...
                    <Input
                      {...register("favicon")}
                      helperText={errors?.favicon ? errors?.favicon.message : null}
                      customCssContainer={{ marginBottom: 30, width: 250 }}
                      type="text"
                      value={getValues("favicon")}
                      onChange={({ target }) => setValue("favicon", target.value)}
                      placeholder="Favicon"
                      label="Favicon"
                      disabled={editMode ? false : true}
                    />
